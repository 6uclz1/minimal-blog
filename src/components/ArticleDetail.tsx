  ...
  return (
    <>
      <article class="bg-gray-900 p-8 md:p-12 rounded-2xl shadow-sm border border-gray-800">
        ...
        {/* Article Content */}
        <div class="prose max-w-none prose-headings:font-bold prose-a:no-underline hover:prose-a:underline prose-img:rounded-xl">
      ...
      <div class="flex justify-center py-8">
        <a
          ...
          onclick="event.preventDefault(); if (document.referrer.indexOf(window.location.host) !== -1) { history.back(); } else { window.location.href = '/minimal-blog/'; }"
        >
          戻る
        </a>
      </div>
